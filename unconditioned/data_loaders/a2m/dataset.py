...
class Dataset(torch.utils.data.Dataset):
    ...
    def get_pose_data(self, data_index, frame_ix):
        ...
        #print("GETTING POSE DATA", pose[-1, :, 0:2].shape)
    ...
    def _load(self, ind, frame_ix):
        ...
        if pose_rep != "xyz":
            ...
            if getattr(self, "_load_rotvec", None) is None:
                ...
                if self.align_pose_frontview:
                    #print("ALIGNING POSE TO FRONTVIEW")
        ...
        if pose_rep != "xyz" and self.translation:
            ...
            padded_tr[:, :3] = ret_tr
            #print("ADDING TRANSLATION ", padded_tr.shape)
            #print("padded_tr", padded_tr[0:5, :])
    ...
    def _get_item_data_index(self, data_index):
        ...
        if np.sum(inp[-1, 3:, :].detach().numpy()) != 0.0:
            print("ERROR")
        #print("INPUT", inp[-1, 0:3, :10].shape)
