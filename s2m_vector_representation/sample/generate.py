...
def main():
    ...
    # for rep_i, (motion, sketch, keyframe) in enumerate(loader):
        ...
        for i, (motion1, sketch1, keyframe1) in enumerate(loader):
            if i == 10:
        ...
        ######
        # # sample = motion
        # motion = torch.unsqueeze(motion, dim=0).permute(0, 3, 1, 2)
        # sample = motion
        # ######
        n_joints = 22
