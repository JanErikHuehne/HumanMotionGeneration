...
def generate_vector_dataset(dataset_path, dataset, save_directory, kinematic_tree):
    ...
    for npy_file in npy_files:
        ...
        generate_vector_representation(npy_file, save_directory, kinematic_tree, joints)
...
def main():
    datapath= r'G:\Course_Document\MuR_RCI\23ws\ADL4CV\HumanMotionGeneration-pip_package\s2m_clip\test_data'
    savepath= r'G:\Course_Document\MuR_RCI\23ws\ADL4CV\HumanMotionGeneration-pip_package\s2m_clip\test_data\Vectors'
    generate_vector_dataset(dataset_path=datapath, dataset='train2', save_directory=savepath, kinematic_tree=[[0, 2, 5, 8, 11], [0, 1, 4, 7, 10], [0, 3, 6, 9, 12, 15], [9, 14, 17, 19, 21], [9, 13, 16, 18, 20]])
    pass
